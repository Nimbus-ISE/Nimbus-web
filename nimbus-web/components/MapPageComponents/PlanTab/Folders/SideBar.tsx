    ...
    return (
        <div className={" h-full z-10 lg:col-span-4"}>
            ...
            {!isBigScreen && !openFullTab && (
                <>
                    <button
                        className="absolute bg-black top-[76vh] left-[88vw] z-10 w-10 h-10 text-white text-center font-extrabold text-2xl rounded cursor-pointer"
                        onClick={() => {
                            dispatch({ type: "TOGGLE_SAVE_PLAN" });
                        }}
                    >
                    ...
                    <button
                        className="absolute bg-black  top-[76vh] left-[76vw] z-10 w-10 h-10 text-white text-center font-extrabold text-2xl rounded cursor-pointer"
                        onClick={() => {
                            dispatch({ type: "OPEN_FULL_FOLDER" });
                        }}
                    >
